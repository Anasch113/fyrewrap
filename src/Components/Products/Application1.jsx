...
<div className='w-full   h-56 wow animate__animated animate__fadeIn '>
  <video autoPlay
    loop
    muted src={product3}  className='w-full h-full object-cover  grayscale hover:grayscale-0 ' alt="" />
</div>
...
<div className='w-full h-56  wow animate__animated animate__fadeIn '>
  <video autoPlay
    loop
    muted src={product4} className='w-full h-full object-cover  grayscale hover:grayscale-0' alt="" />
</div>
</div>
</div>
