...
<div className="absolute inset-y-56 flex justify-center flex-col bg-gray-600 bg-opacity-85  p-10 w-2/4 transform translate-y-56 wow animate__animated animate__fadeInUp animate__delay-1s max-[1200px]:w-2/3 max-[800px]:w-full max-[800px]:inset-y-40 max-[800px]:translate-y-40">
